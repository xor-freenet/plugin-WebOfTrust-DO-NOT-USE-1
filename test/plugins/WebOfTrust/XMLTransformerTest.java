...
public class XMLTransformerTest extends AbstractJUnit3BaseTest {
	...
	public void testImportIdentity() throws Exception {
		...
		// FIXME: This is a test for bug 4850. Remove or clean it up at least as soon as we have figured out what is going on.
		Identity id = mWoT.addIdentity("USK@bbSUQPElk2x5dxX8n1~sUNxpywAcRcwOBjzfD7opJ3M,HxGCqlOHJoIDPW6RxFDRKZNzk-QUZJmLr7oUfJ9jG~4,AQACAAE/WebOfTrustRC2/10");
		mWoT.setTrust(mOwnIdentity, id, (byte)100, "test");
		...
		mTransformer.importIdentity(new FreenetURI("USK@bbSUQPElk2x5dxX8n1~sUNxpywAcRcwOBjzfD7opJ3M,HxGCqlOHJoIDPW6RxFDRKZNzk-QUZJmLr7oUfJ9jG~4,AQACAAE/WebOfTrustRC2/10"), new ByteArrayInputStream(rawXML.getBytes("UTF-8")));
	}
