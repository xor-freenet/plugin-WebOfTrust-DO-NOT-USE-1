...
public class XMLTransformerTest extends AbstractJUnit3BaseTest {
	...
	/** Not implemented here, see {@link IdentityFileQueueTest}. */
	public void testExportOwnIdentity() {
		// TODO: Test that we do not export the trust list if trust list export is disabled, that
		// is not covered by IdentityFileQueueTest.
	}
